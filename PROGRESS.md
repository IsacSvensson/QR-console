...
**Current milestone:** M18 — Music, access codes, delivery (Part 2: BLACKBOX)
...
| BLACKBOX ROM / cartridge | 24.4 KB of 32 KB ROM (74 %) / 14.0 KB cartridge; 4 endings replayed (7.4k–8.2k frames each) | test:blackbox |
